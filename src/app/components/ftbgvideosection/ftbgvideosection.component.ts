...
@Component({
  selector: 'app-ftbgvideosection',
  templateUrl: './ftbgvideosection.component.html',
  styleUrls: ['./ftbgvideosection.component.css']
})
export class FtbgvideosectionComponent implements OnInit {
